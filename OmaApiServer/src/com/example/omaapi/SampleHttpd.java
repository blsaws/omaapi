...
*/
    private static final String QUERY_STRING_PARAMETER = "SampleHttpd.QUERY_STRING";

    /**
* Constructs an HTTP server on given port.
*/
    public SampleHttpd(int port) {
        this(null, port);
    }
...
*/
    public void start() throws IOException {
        ...
        myThread.setName("SampleHttpd Main Listener");
        myThread.start();
    }
...
* element.
*
* @param parms original <b>SampleHttpd</b> parameters values, as passed to the <code>serve()</code> method.
...
*/
    ...
    /**
* Default threading strategy for SampleHttpd.
*
...
*/
    public static class DefaultAsyncRunner implements AsyncRunner {
        ...
        public void exec(Runnable code) {
            ...
            t.setDaemon(true);
            t.setName("SampleHttpd Request Processor (#" + requestCount + ")");
            t.start();
        }
    }
...
*/
    public static class DefaultTempFile implements TempFile {
        ...
        public DefaultTempFile(String tempdir) throws IOException {
            file = File.createTempFile("SampleHttpd-", "", new File(tempdir));
